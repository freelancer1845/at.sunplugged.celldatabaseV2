...
public class ChartDescriptor {
  ...
  public void postConstruct(Composite parent) {
     ...
     * 
     * @Override public void controlResized(ControlEvent e) { drawPlot(); super.controlResized(e); }
     * });
     * 
     * 
     * chartComposite = new ChartComposite(composite, SWT.NONE); chartComposite.setLayoutData(new
     * GridData(SWT.FILL, SWT.FILL, true, true));
     * 
     * drawPlot();
     * 
     * Group controlGroup = new Group(composite, SWT.BORDER); controlGroup.setText("Options");
     * 
     ...
     * 
     * Button cbPowerCurve = new Button(controlGroup, SWT.CHECK); cbPowerCurve.setLayoutData(new
     * GridData(SWT.RIGHT, SWT.CENTER, false, false)); cbPowerCurve.addSelectionListener(new
     * SelectionAdapter() {
     * 
     * @Override public void widgetSelected(SelectionEvent e) { if (cbPowerCurve.getSelection() ==
     * false) { options.remove(PlotHelper.POWER_CURVE); } else { options.put(PlotHelper.POWER_CURVE,
     * "true"); } drawPlot(); } });
     * 
     * Label lblPowerMarker = new Label(controlGroup, SWT.NONE);
     * lblPowerMarker.setText("Draw Power Marker"); lblPowerMarker.setLayoutData(new
     * GridData(SWT.LEFT, SWT.CENTER, true, false));
     * 
     * Button cbPowerMarker = new Button(controlGroup, SWT.CHECK); cbPowerMarker.setLayoutData(new
     * GridData(SWT.RIGHT, SWT.CENTER, false, false)); cbPowerMarker.addSelectionListener(new
     * SelectionAdapter() {
     * 
     * @Override public void widgetSelected(SelectionEvent e) { if (cbPowerMarker.getSelection() ==
     * false) { options.remove(PlotHelper.MP_POINT); } else { options.put(PlotHelper.MP_POINT,
     * "true"); } drawPlot(); } });
     * 
     ...
     * (cbPowerCurveFitSeries.getSelection() == false) { options.remove(PlotHelper.POWER_CURVE_FIT);
     * } else { options.put(PlotHelper.POWER_CURVE_FIT, "true"); } drawPlot(); } });
     * 
     * Label lblRsSeries = new Label(controlGroup, SWT.NONE); lblRsSeries.setText("Draw RS Series");
     * lblRsSeries.setLayoutData(new GridData(SWT.LEFT, SWT.CENTER, true, false));
     * 
     * Button cbRsSeries = new Button(controlGroup, SWT.CHECK); cbRsSeries.setLayoutData(new
     * GridData(SWT.RIGHT, SWT.CENTER, false, false)); cbRsSeries.addSelectionListener(new
     * SelectionAdapter() {
     * 
     * @Override public void widgetSelected(SelectionEvent e) { if (cbRsSeries.getSelection() ==
     * false) { options.remove(PlotHelper.RS_LINE); } else { options.put(PlotHelper.RS_LINE,
     * "true"); } drawPlot(); } });
     * 
     * Label lblRpSeries = new Label(controlGroup, SWT.NONE); lblRpSeries.setText("Draw Rp Series");
     * lblRpSeries.setLayoutData(new GridData(SWT.LEFT, SWT.CENTER, true, false));
     * 
     * Button cbRpSeries = new Button(controlGroup, SWT.CHECK); cbRpSeries.setLayoutData(new
     * GridData(SWT.RIGHT, SWT.CENTER, false, false)); cbRpSeries.addSelectionListener(new
     * SelectionAdapter() {
     * 
     * @Override public void widgetSelected(SelectionEvent e) { if (cbRpSeries.getSelection() ==
     * false) { options.remove(PlotHelper.RP_LINE); } else { options.put(PlotHelper.RP_LINE,
     * "true"); } drawPlot(); } });
     * 
     * Label lbllightUiFitSeries = new Label(controlGroup, SWT.NONE);
     * lbllightUiFitSeries.setText("Draw Voc/Rs Fit Series"); lbllightUiFitSeries.setLayoutData(new
     * GridData(SWT.LEFT, SWT.CENTER, true, false));
     * 
     ...
     * 
     * @Override public void widgetSelected(SelectionEvent e) { if
     * (cblightUiFitSeries.getSelection() == false) { options.remove(PlotHelper.VOC_RS_FIT); } else
     * { options.put(PlotHelper.VOC_RS_FIT, "true"); } drawPlot(); } }); Label lbldarkUiFitSeries =
     * new Label(controlGroup, SWT.NONE); lbldarkUiFitSeries.setText("Draw Isc/Rp Fit Series");
     ...
     * 
     * @Override public void widgetSelected(SelectionEvent e) { if (cbdarkUiFitSeries.getSelection()
     * == false) { options.remove(PlotHelper.ISC_RP_FIT); } else {
     * options.put(PlotHelper.ISC_RP_FIT, "true"); } drawPlot(); } });
     * 
     * addOption(controlGroup, "Draw Dark Rp Fit", PlotHelper.DARK_RP_FIT); addOption(controlGroup,
     * "Draw Dark Rs Fit", PlotHelper.DARK_RS_FIT);
     */
  }
