 ...
 * Coefficients</em>}</li>
 * <li>{@link datamodel.impl.CellResultImpl#getDarkRpFitCoefficients <em>Dark Rp Fit
 * Coefficients</em>}</li>
 * <li>{@link datamodel.impl.CellResultImpl#getDarkRsFitCoefficients <em>Dark Rs Fit
 * Coefficients</em>}</li>
...
public class CellResultImpl extends MinimalEObjectImpl.Container implements CellResult {
  ...
  /**
   * The cached value of the '{@link #getDarkRpFitCoefficients() <em>Dark Rp Fit Coefficients</em>}'
   * attribute list. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * The cached value of the '{@link #getDarkRsFitCoefficients() <em>Dark Rs Fit Coefficients</em>}'
   * attribute list. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  public void setNumberOfCells(int newNumberOfCells) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET,
          DatamodelPackage.CELL_RESULT__NUMBER_OF_CELLS, oldNumberOfCells, numberOfCells));
  }
  ...
  public EList<Double> getDarkRpFitCoefficients() {
    if (darkRpFitCoefficients == null) {
      darkRpFitCoefficients = new EDataTypeUniqueEList<Double>(Double.class, this,
          DatamodelPackage.CELL_RESULT__DARK_RP_FIT_COEFFICIENTS);
    }
  ...
  public EList<Double> getDarkRsFitCoefficients() {
    if (darkRsFitCoefficients == null) {
      darkRsFitCoefficients = new EDataTypeUniqueEList<Double>(Double.class, this,
          DatamodelPackage.CELL_RESULT__DARK_RS_FIT_COEFFICIENTS);
    }
